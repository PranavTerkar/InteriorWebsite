...
// import './styles/project.css's
function Bigproject() {
  return (
    <div>
      <h2 style={{ margin: "30px 0 " }}>Latest Project</h2>
      <div className="mainproject  justify-content-center">
        <div>
          <div style={{ background: "#FCFFE7" }}>
            <a href="#">
              <img
                style={{ height: "900px" }}
        ...
        <div>
          <div style={{ background: "#FCFFE7" }} className="item">
            <a href="#">
              <img
